        ...
        <table class="min-w-full bg-white border-separate border-spacing-0">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm">
                    ...
                    <th class="py-3 px-6 text-left border-b border-gray-300">Reserve Time</th>
                    <th class="py-3 px-6 text-left border-b border-gray-300">Purpose</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-4">No consultations found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
